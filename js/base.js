var main = function () {
	...
	$("#music-control").click(function() {
		if( $("#music-player").css("visibility") == "hidden")
		{
	...
	$("#toggle-img").click(function() {
		...
		{
	        $("#toggle_x").addClass("clicked");
			$("#toggle_o").css("display","none");
			$("#toggle_x").css("display","block");
			$("#toggle-img").addClass("clicked");
			$("#resume").slideDown(500);
		}
		else
		{
			$("#toggle_o").css("display","block");
			$("#toggle_x").css("display","none");
			$("#toggle-img").removeClass("clicked");
			$("#resume").slideUp(700);
		}
	});
};
